...
const SUITE: { name: string; category: string; os: string; path: string; description: string; downloadUrl?: string }[] = [
  ...
  { name: "Rift", category: "GameApplication", os: "Web", path: "/rift", description: "A 60fps neon arena-survival game on a hand-written Canvas engine — escalating waves, deep upgrades, sentries and sector bosses. Best played on desktop." },
